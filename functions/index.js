...
// OUTIL ADMIN TEMPORAIRE — correction des 30 questions FTM corrompues par le parser CSV buggy
// À supprimer après exécution confirmée.
app.post("/api/admin/fix-ftm-questions", requireAuth, async (req, res) => {
  try {
    if (!(await isRequesterAdmin(req.user.uid))) return res.status(403).json({ error: "Accès refusé" });
    const dryRun = req.body.dryRun !== false;

    const FTM_CORRECTIONS = [
      { pedagogicalId: "PHARM-FTM-000053", question: "Dans le cadre des préparations officinales, que traduit principalement la qualité d'un produit ?", reponse_A: "Sa conformité à une méthode de fabrication rapide et économique.", reponse_B: "Sa concordance avec les exigences applicables et les attentes raisonnables.", reponse_C: "L'absence totale de variation entre deux préparateurs différents.", reponse_D: "Son aspect visuel comparable à celui d'une spécialité industrielle.", bonne_reponse_index: 1, bonne_reponse_texte: "Sa concordance avec les exigences applicables et les attentes raisonnables.", explication: "La qualité correspond au degré de concordance du produit avec les exigences applicables et les attentes raisonnables. La rapidité, l'économie ou le seul aspect visuel ne suffisent pas à la définir." },
      { pedagogicalId: "PHARM-FTM-000054", question: "Quelle étape suit directement la planification et l'établissement du protocole de préparation ?", reponse_A: "Le conditionnement définitif de la préparation.", reponse_B: "L'analyse de la prescription ou de la demande.", reponse_C: "La réalisation proprement dite, accompagnée de sa documentation.", reponse_D: "L'étiquetage légal destiné au patient.", bonne_reponse_index: 2, bonne_reponse_texte: "La réalisation proprement dite, accompagnée de sa documentation.", explication: "Dans les sept étapes décrites, la planification et l'établissement du protocole précèdent la réalisation proprement dite, qui doit être documentée. Le conditionnement et l'étiquetage interviennent ensuite." },
      { pedagogicalId: "PHARM-FTM-000055", question: "Quels sont les critères microbiologiques applicables aux gélules non stériles en préparation officinale ?", reponse_A: "Maximum 1 000 aérobies et 100 fongiques par gramme, sans E. coli.", reponse_B: "Maximum 100 aérobies et 10 fongiques par gramme, sans Pseudomonas.", reponse_C: "Aucune souche microbienne ne peut être détectée dans l'échantillon.", reponse_D: "Maximum 10 000 aérobies, sans limite imposée aux souches fongiques.", bonne_reponse_index: 0, bonne_reponse_texte: "Maximum 1 000 aérobies et 100 fongiques par gramme, sans E. coli.", explication: "Pour les gélules, la limite indiquée est de 1 000 souches microbiennes aérobies et 100 souches fongiques par gramme, avec absence d'E. coli. Les seuils de 100 et 10 concernent d'autres formes." },
      { pedagogicalId: "PHARM-FTM-000056", question: "Pour une crème non stérile en préparation officinale, quelle exigence microbiologique est applicable ?", reponse_A: "Maximum 1 000 aérobies et 100 fongiques, sans E. coli.", reponse_B: "Stérilité complète pendant toute la durée de validité.", reponse_C: "Maximum 100 aérobies et 10 fongiques, avec absence d'E. coli uniquement.", reponse_D: "Maximum 100 aérobies et 10 fongiques, sans S. aureus ni P. aeruginosa.", bonne_reponse_index: 3, bonne_reponse_texte: "Maximum 100 aérobies et 10 fongiques, sans S. aureus ni P. aeruginosa.", explication: "Pour les crèmes, onguents et gouttes nasales non stériles, le seuil est de 100 aérobies et 10 fongiques par gramme ou millilitre, avec absence de S. aureus et de P. aeruginosa." },
      { pedagogicalId: "PHARM-FTM-000057", question: "Après ouverture, quelle durée de conservation de l'eau purifiée est indiquée ?", reponse_A: "Une semaine à température ambiante et un mois au réfrigérateur.", reponse_B: "Vingt-quatre heures à température ambiante et une semaine au réfrigérateur.", reponse_C: "Quarante-huit heures à température ambiante et deux semaines au réfrigérateur.", reponse_D: "Un mois, quelle que soit la température de conservation.", bonne_reponse_index: 1, bonne_reponse_texte: "Vingt-quatre heures à température ambiante et une semaine au réfrigérateur.", explication: "Après ouverture, l'eau purifiée se contamine rapidement. La conservation est limitée à 24 heures à température ambiante ou à une semaine au réfrigérateur." },
      { pedagogicalId: "PHARM-FTM-000058", question: "Quel mécanisme du bag-in-box limite la recontamination de l'eau lors des prélèvements ?", reponse_A: "Une pompe injecte de l'air filtré après chaque prélèvement.", reponse_B: "Le récipient rigide maintient une pression positive permanente.", reponse_C: "La poche se déforme et le robinet empêche le retour d'air.", reponse_D: "L'eau est automatiquement chauffée avant chaque distribution.", bonne_reponse_index: 2, bonne_reponse_texte: "La poche se déforme et le robinet empêche le retour d'air.", explication: "Lors du prélèvement, la poche souple se rétracte sous l'effet de la gravité et le robinet empêche le retour d'air. L'absence d'entrée d'air limite ainsi la recontamination de l'eau." },
      { pedagogicalId: "PHARM-FTM-000059", question: "Une préparation prescrite paraît dangereuse au regard des connaissances actuelles. Que doit faire le pharmacien ?", reponse_A: "Refuser sa réalisation après analyse et documentation appropriées.", reponse_B: "La réaliser sans modification afin de respecter la liberté thérapeutique.", reponse_C: "La confier à un préparateur expérimenté sans autre vérification.", reponse_D: "Réduire arbitrairement la dose puis délivrer la préparation.", bonne_reponse_index: 0, bonne_reponse_texte: "Refuser sa réalisation après analyse et documentation appropriées.", explication: "Le pharmacien est responsable de la décision de réaliser la préparation. Après s'être documenté, il doit y renoncer si elle est dangereuse ou non conforme à l'état des connaissances." },
      { pedagogicalId: "PHARM-FTM-000060", question: "Quel principe s'applique aux préparations réalisées à la demande du patient, sans prescription ?", reponse_A: "Elles échappent à l'analyse critique puisqu'elles ne sont pas prescrites.", reponse_B: "Seule leur présentation commerciale doit être évaluée.", reponse_C: "Le pharmacien peut employer toute matière première disponible à l'officine.", reponse_D: "Elles exigent le même esprit critique concernant composition, formulation et validité.", bonne_reponse_index: 3, bonne_reponse_texte: "Elles exigent le même esprit critique concernant composition, formulation et validité.", explication: "L'absence de prescription ne dispense pas de l'analyse pharmaceutique. Les préparations de conseil exigent le même esprit critique pour la composition, la formulation et la durée de validité." },
      { pedagogicalId: "PHARM-FTM-000061", question: "Quelle règle s'applique aux matières premières incorporées dans une préparation ?", reponse_A: "Une qualité alimentaire suffit si la substance est bien connue.", reponse_B: "La qualité pharmaceutique n'est requise que pour les principes actifs.", reponse_C: "Toutes doivent être pharmaceutiques; celles de conseil doivent aussi être autorisées.", reponse_D: "Les excipients peuvent provenir d'un conditionnement non identifié.", bonne_reponse_index: 2, bonne_reponse_texte: "Toutes doivent être pharmaceutiques; celles de conseil doivent aussi être autorisées.", explication: "Toutes les matières premières incorporées doivent être de qualité pharmaceutique. Pour une préparation de conseil, elles doivent en outre faire partie des matières premières autorisées." },
      { pedagogicalId: "PHARM-FTM-000062", question: "Quel contrôle d'une balance doit être effectué au moins une fois par jour ?", reponse_A: "La conformité par un service de métrologie.", reponse_B: "La vérification de son horizontalité.", reponse_C: "L'exactitude avec un poids étalon.", reponse_D: "Le remplacement de la cellule de pesée.", bonne_reponse_index: 1, bonne_reponse_texte: "La vérification de son horizontalité.", explication: "L'horizontalité de la balance doit être vérifiée au moins une fois par jour. L'exactitude avec un poids étalon est hebdomadaire et la conformité métrologique est vérifiée au moins tous les quatre ans." },
      { pedagogicalId: "PHARM-FTM-000063", question: "Pourquoi peser 100 mg sur une balance lisible au centigramme est-il particulièrement critique ?", reponse_A: "Un centigramme représente seulement 0,1 % de la masse visée.", reponse_B: "La balance arrondit obligatoirement la masse à 100 mg.", reponse_C: "La portée maximale devient inférieure à la masse pesée.", reponse_D: "Un centigramme représente déjà 10 % de la masse visée.", bonne_reponse_index: 3, bonne_reponse_texte: "Un centigramme représente déjà 10 % de la masse visée.", explication: "Cent milligrammes correspondent à dix centigrammes : une variation d'un centigramme représente 10 % de la masse visée. Comme le dernier chiffre affiché n'est pas nécessairement significatif, l'erreur relative peut être majeure." },
      { pedagogicalId: "PHARM-FTM-000064", question: "Quelle mesure est recommandée pour une forme sèche contenant moins de 10 mg de principe actif par unité ?", reponse_A: "Appliquer un surdosage de 5 % pour compenser les pertes potentielles.", reponse_B: "Supprimer le diluant afin de réduire le volume du mélange.", reponse_C: "Ajouter le principe actif uniquement après le remplissage des gélules.", reponse_D: "Tolérer une teneur comprise entre 80 % et 120 %.", bonne_reponse_index: 0, bonne_reponse_texte: "Appliquer un surdosage de 5 % pour compenser les pertes potentielles.", explication: "Sous 10 mg de principe actif par unité, l'adsorption dans le mortier et les effets électrostatiques peuvent entraîner des pertes. Un surdosage de 5 % est recommandé pour les formes sèches concernées." },
      { pedagogicalId: "PHARM-FTM-000065", question: "Une trituration de dexaméthasone sert à préparer des gélules contenant moins de 10 mg par unité. Quelle approche convient ?", reponse_A: "N'appliquer aucun surdosage puisque la trituration compense déjà toutes les pertes.", reponse_B: "Appliquer uniquement le surdosage lié au remplissage des gélules.", reponse_C: "Prendre en compte successivement les deux surdosages de 5 %.", reponse_D: "Remplacer les deux corrections par une marge unique de 2,5 %.", bonne_reponse_index: 2, bonne_reponse_texte: "Prendre en compte successivement les deux surdosages de 5 %.", explication: "Les surdosages doivent être cumulés. Pour la dexaméthasone, il faut tenir compte du surdosage de la trituration puis de celui lié à la dose unitaire inférieure à 10 mg." },
      { pedagogicalId: "PHARM-FTM-000066", question: "Comment limiter l'inhomogénéité lorsque les constituants présentent des granulométries différentes ?", reponse_A: "Tamiser uniquement les particules les plus fines.", reponse_B: "Pulvériser les particules les plus grosses avant le mélange.", reponse_C: "Ajouter immédiatement un liquide mouillant au mélange.", reponse_D: "Peser chaque constituant sur une balance différente.", bonne_reponse_index: 1, bonne_reponse_texte: "Pulvériser les particules les plus grosses avant le mélange.", explication: "Des particules de tailles différentes peuvent se séparer et rendre le mélange hétérogène. Pulvériser les particules les plus grosses rapproche les granulométries et facilite un mélange homogène." },
      { pedagogicalId: "PHARM-FTM-000067", question: "À quel moment faut-il incorporer un constituant volatil dans une préparation ?", reponse_A: "Avant toute autre matière première.", reponse_B: "Pendant la pulvérisation prolongée des poudres.", reponse_C: "Après une attente à l'air libre.", reponse_D: "En dernier lieu, afin de limiter les pertes.", bonne_reponse_index: 3, bonne_reponse_texte: "En dernier lieu, afin de limiter les pertes.", explication: "Un constituant volatil peut s'évaporer pendant les manipulations prolongées. Son incorporation en dernier lieu réduit son temps d'exposition et limite les pertes." },
      { pedagogicalId: "PHARM-FTM-000068", question: "Un principe actif contient une proportion variable d'eau et sa teneur est exprimée sur matière sèche. Que faut-il faire ?", reponse_A: "Adapter la pesée à la teneur réelle ou appliquer une correction justifiée.", reponse_B: "Peser systématiquement la quantité théorique sans correction.", reponse_C: "Corriger uniquement le volume final de la préparation.", reponse_D: "Remplacer le principe actif par un excipient anhydre.", bonne_reponse_index: 0, bonne_reponse_texte: "Adapter la pesée à la teneur réelle ou appliquer une correction justifiée.", explication: "La quantité à peser doit tenir compte de la teneur réelle du principe actif, notamment lorsque l'eau ou les impuretés font varier sa teneur. Une correction ou un surdosage justifié permet d'obtenir la teneur cible." },
      { pedagogicalId: "PHARM-FTM-000069", question: "Quel est l'objectif principal d'un protocole pour une préparation récurrente ?", reponse_A: "Accélérer la délivrance en supprimant les contrôles documentés.", reponse_B: "Garantir la constance et la reproductibilité de la qualité.", reponse_C: "Permettre à chaque préparateur d'adapter librement la méthode.", reponse_D: "Éviter l'utilisation d'une fiche de pesée par lot.", bonne_reponse_index: 1, bonne_reponse_texte: "Garantir la constance et la reproductibilité de la qualité.", explication: "Un protocole commun évite que plusieurs préparateurs utilisent des méthodes différentes. Il vise à assurer la constance et la reproductibilité de la qualité d'un lot à l'autre." },
      { pedagogicalId: "PHARM-FTM-000070", question: "Quel élément ne fait pas partie du contenu attendu d'un protocole de préparation ?", reponse_A: "Le matériel, les matières premières et le conditionnement nécessaires.", reponse_B: "Le mode opératoire et les contrôles à effectuer.", reponse_C: "Le diagnostic médical détaillé de chaque patient futur.", reponse_D: "Un modèle de fiche de pesée et d'étiquette.", bonne_reponse_index: 2, bonne_reponse_texte: "Le diagnostic médical détaillé de chaque patient futur.", explication: "Le protocole doit préciser le matériel, les matières premières, le conditionnement, le mode opératoire, les contrôles, ainsi que des modèles de fiche de pesée et d'étiquette. Le diagnostic détaillé d'un futur patient n'en fait pas partie." },
      { pedagogicalId: "PHARM-FTM-000071", question: "Quelle organisation réduit le risque d'erreur pendant la réalisation d'une préparation ?", reponse_A: "Deux préparateurs alternent les pesées pour accélérer le travail.", reponse_B: "Le conditionnement est reporté à la fin de la journée.", reponse_C: "La préparation est interrompue après chaque pesée pour vérification externe.", reponse_D: "Un préparateur réalise une suite continue jusqu'au conditionnement et à l'étiquetage.", bonne_reponse_index: 3, bonne_reponse_texte: "Un préparateur réalise une suite continue jusqu'au conditionnement et à l'étiquetage.", explication: "Le principe retenu est : une préparation, un préparateur et une suite continue d'opérations, conditionnement et étiquetage compris. Cette organisation limite les interruptions, interversions et omissions." },
      { pedagogicalId: "PHARM-FTM-000072", question: "Que faut-il inscrire comme quantité réellement pesée sur la fiche de pesée ?", reponse_A: "Le nombre lu sur la balance au moment exact de la pesée.", reponse_B: "La quantité théorique calculée avant la préparation.", reponse_C: "La quantité arrondie au gramme supérieur.", reponse_D: "La moyenne des pesées réalisées pendant la semaine.", bonne_reponse_index: 0, bonne_reponse_texte: "Le nombre lu sur la balance au moment exact de la pesée.", explication: "La quantité réellement pesée est le nombre effectivement lu sur la balance au moment de la pesée. Elle ne doit pas être remplacée par la quantité théorique ni par une valeur arrondie a posteriori." },
      { pedagogicalId: "PHARM-FTM-000073", question: "Lors de la délivrance d'une préparation provenant d'un lot en réserve, quelle traçabilité est attendue ?", reponse_A: "Créer une nouvelle fiche de pesée complète pour chaque délivrance.", reponse_B: "Inscrire uniquement la quantité délivrée dans le dossier patient.", reponse_C: "Ajouter patient, date et éventuellement ordonnance au rapport du lot initial.", reponse_D: "Remplacer l'étiquette du lot sans modifier le rapport de préparation.", bonne_reponse_index: 2, bonne_reponse_texte: "Ajouter patient, date et éventuellement ordonnance au rapport du lot initial.", explication: "Pour un lot en réserve, un seul rapport de préparation est établi par lot. À chaque délivrance, le nom du patient, la date et, le cas échéant, le numéro d'ordonnance sont ajoutés au rapport initial." },
      { pedagogicalId: "PHARM-FTM-000074", question: "Quelles caractéristiques doit présenter le contrôle d'une préparation officinale ?", reponse_A: "Destructif, exhaustif et réalisé uniquement après conditionnement.", reponse_B: "Non destructif, simple, efficace et documenté.", reponse_C: "Réservé aux préparations contenant un principe actif puissant.", reponse_D: "Effectué uniquement par un laboratoire externe accrédité.", bonne_reponse_index: 1, bonne_reponse_texte: "Non destructif, simple, efficace et documenté.", explication: "Un contrôle est toujours possible pendant ou après la préparation. Il doit être non destructif, efficace mais simple, et son résultat doit être documenté sur la fiche de pesée et, si prévu, dans le protocole." },
      { pedagogicalId: "PHARM-FTM-000075", question: "Quel contrôle est particulièrement pertinent pour une suspension avant sa délivrance ?", reponse_A: "La couleur du bouchon de sécurité.", reponse_B: "La masse du conditionnement vide uniquement.", reponse_C: "La date d'achat de la balance.", reponse_D: "L'homogénéité et la redispersibilité de la préparation.", bonne_reponse_index: 3, bonne_reponse_texte: "L'homogénéité et la redispersibilité de la préparation.", explication: "Une suspension doit rester homogène ou pouvoir être facilement remise en suspension avant l'administration. L'homogénéité et la redispersibilité sont donc des contrôles directement pertinents." },
      { pedagogicalId: "PHARM-FTM-000076", question: "La masse moyenne d'une gélule vide est 80 mg et celle d'une pleine 330 mg. Quel intervalle s'applique à chaque gélule pleine ?", reponse_A: "De 311,25 mg à 348,75 mg.", reponse_B: "De 305 mg à 355 mg.", reponse_C: "De 231,25 mg à 268,75 mg.", reponse_D: "De 250 mg à 330 mg.", bonne_reponse_index: 0, bonne_reponse_texte: "De 311,25 mg à 348,75 mg.", explication: "Le contenu moyen vaut 330 − 80 = 250 mg. Les limites du contenu sont 250 ± 7,5 %, soit 231,25 à 268,75 mg ; en rajoutant les 80 mg de l'enveloppe, on obtient 311,25 à 348,75 mg." },
      { pedagogicalId: "PHARM-FTM-000077", question: "Quel programme de contrôle de régularité de masse est recommandé en préparation officinale ?", reponse_A: "Contrôler chaque préparation, toujours avec la même formule simple.", reponse_B: "Contrôler mensuellement uniquement les préparations destinées aux adultes.", reponse_C: "Contrôler au moins chaque semaine, varier les préparations et renforcer les cas difficiles.", reponse_D: "Contrôler uniquement après une réclamation d'un patient.", bonne_reponse_index: 2, bonne_reponse_texte: "Contrôler au moins chaque semaine, varier les préparations et renforcer les cas difficiles.", explication: "Le contrôle de régularité de masse doit être réalisé au moins une fois par semaine, de manière aléatoire, en variant les préparations. Les préparations difficiles ou à risque doivent être contrôlées plus fréquemment." },
      { pedagogicalId: "PHARM-FTM-000078", question: "Quel est un rôle essentiel du conditionnement d'une préparation ?", reponse_A: "Modifier sa composition pendant la conservation.", reponse_B: "La protéger de l'humidité, de l'oxygène, de la lumière et des contaminations.", reponse_C: "Remplacer les contrôles réalisés pendant la préparation.", reponse_D: "Garantir une stabilité identique pour toutes les formes pharmaceutiques.", bonne_reponse_index: 1, bonne_reponse_texte: "La protéger de l'humidité, de l'oxygène, de la lumière et des contaminations.", explication: "Le conditionnement protège la préparation contre l'humidité, l'oxygène, la lumière et la contamination microbienne. Il contribue ainsi au maintien de sa qualité jusqu'à la date de péremption." },
      { pedagogicalId: "PHARM-FTM-000079", question: "Des gélules maison contenant un extrait sec ont une validité de deux mois. Quel choix est approprié ?", reponse_A: "Une boîte en carton, puisque la préparation est sèche.", reponse_B: "Une boîte en carton doublée d'une simple feuille de papier.", reponse_C: "Tout conditionnement convient si le patient conserve les gélules au sec.", reponse_D: "Un conditionnement protecteur adapté, autre qu'une boîte en carton.", bonne_reponse_index: 3, bonne_reponse_texte: "Un conditionnement protecteur adapté, autre qu'une boîte en carton.", explication: "Les boîtes en carton ne sont admises que pour certaines gélules stables à validité très courte, inférieure à un mois. Elles sont déconseillées pour les extraits secs et ne conviennent pas aux préparations maison." },
      { pedagogicalId: "PHARM-FTM-000080", question: "Quelle information doit figurer sur l'étiquette d'une préparation magistrale ?", reponse_A: "Le numéro d'ordre, le patient, le prescripteur, la date réelle, la posologie et la péremption.", reponse_B: "Uniquement le nom du principe actif et le prix payé.", reponse_C: "La formule complète avec tous les excipients et leurs numéros de lot.", reponse_D: "La mention « usage connu » en remplacement de la posologie.", bonne_reponse_index: 0, bonne_reponse_texte: "Le numéro d'ordre, le patient, le prescripteur, la date réelle, la posologie et la péremption.", explication: "L'étiquette d'une préparation magistrale doit assurer l'identification et la traçabilité : numéro d'ordre, patient, médecin, date réelle, date de péremption et posologie. La mention « usage connu » n'est pas acceptable." },
      { pedagogicalId: "PHARM-FTM-000081", question: "Quelle affirmation concernant la stabilité des préparations est correcte ?", reponse_A: "Une instabilité importante est toujours visible rapidement.", reponse_B: "Toutes les crèmes peuvent recevoir la même durée de validité.", reponse_C: "L'eau et la multiplication des constituants tendent à réduire la stabilité.", reponse_D: "Le conditionnement choisi n'influence pas la stabilité finale.", bonne_reponse_index: 2, bonne_reponse_texte: "L'eau et la multiplication des constituants tendent à réduire la stabilité.", explication: "La stabilité dépend notamment des constituants, de leur association, de la forme, de la fabrication, de la conservation et du conditionnement. L'eau et l'augmentation du nombre de constituants tendent à réduire la stabilité." },
    ...
    for (const row of FTM_CORRECTIONS) results.push({ pedagogicalId: row.pedagogicalId, status: dryRun ? "à mettre à jour" : "mis à jour" });
    res.json({ total: FTM_CORRECTIONS.length, dryRun, results });
  } catch (err) {
    console.error("[fix-ftm-questions]", err && err.code, err);
    res.status(500).json({ error: err.message || "Erreur serveur" });
  }
});
